# Digital-Stop-Watch
Designed a stop watch with 4 digit display showing seconds and 1/100 second. A push button was used to go through a cycle of three states, viz. RESET, START and STOP sequentially.
